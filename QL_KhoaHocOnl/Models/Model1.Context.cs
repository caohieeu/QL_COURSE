...
namespace QL_KhoaHocOnl.Models
{
    ...
    public partial class QL_COURSEEntities1 : DbContext
    {
        public QL_COURSEEntities1()
            : base("name=QL_COURSEEntities1")
        {
        }
        ...
        [DbFunction("QL_COURSEEntities1", "FN_FILTER_BY_MAX_STUDENT_STUDY_COURSE")]
        public virtual IQueryable<FN_FILTER_BY_MAX_STUDENT_STUDY_COURSE_Result> FN_FILTER_BY_MAX_STUDENT_STUDY_COURSE()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<FN_FILTER_BY_MAX_STUDENT_STUDY_COURSE_Result>("[QL_COURSEEntities1].[FN_FILTER_BY_MAX_STUDENT_STUDY_COURSE]()");
        }
    
        [DbFunction("QL_COURSEEntities1", "fn_ShowAllLesson")]
        public virtual IQueryable<fn_ShowAllLesson_Result> fn_ShowAllLesson(string iD_COURSE)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_ShowAllLesson_Result>("[QL_COURSEEntities1].[fn_ShowAllLesson](@ID_COURSE)", iD_COURSEParameter);
        }
    
        [DbFunction("QL_COURSEEntities1", "FN_ShowCourseOfTeacher")]
        public virtual IQueryable<FN_ShowCourseOfTeacher_Result> FN_ShowCourseOfTeacher(string iD_TEACHER)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<FN_ShowCourseOfTeacher_Result>("[QL_COURSEEntities1].[FN_ShowCourseOfTeacher](@ID_TEACHER)", iD_TEACHERParameter);
        }
        ...
        public virtual int SP_INCREASE_PRICE_COURSE(string nAME_TEACHER, Nullable<double> iNCREASE_PRICE)
        {
            var nAME_TEACHERParameter = nAME_TEACHER != null ?
                new ObjectParameter("NAME_TEACHER", nAME_TEACHER) :
                new ObjectParameter("NAME_TEACHER", typeof(string));
    
            var iNCREASE_PRICEParameter = iNCREASE_PRICE.HasValue ?
                new ObjectParameter("INCREASE_PRICE", iNCREASE_PRICE) :
                new ObjectParameter("INCREASE_PRICE", typeof(double));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_INCREASE_PRICE_COURSE", nAME_TEACHERParameter, iNCREASE_PRICEParameter);
        }
