...
namespace QL_KhoaHocOnl.Areas.Admin.Controllers
{
    public class GiangVienController : Controller
    {
        ...
        public ActionResult FilterByMaxStudent()
        {
            var listTeacher = db.FN_FILTER_BY_MAX_STUDENT_STUDY_COURSE().ToList();
            return View(listTeacher);
        }
        ...
        public ActionResult AddTeacher(TEACHER teacher)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("", " Thumbnail phải là chuỗi có 4 phần tử cuối có dạng .jpg hoặc .png");
                    return View(teacher);
                }
